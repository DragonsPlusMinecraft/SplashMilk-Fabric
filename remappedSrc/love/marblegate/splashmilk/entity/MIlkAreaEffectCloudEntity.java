...
public class MIlkAreaEffectCloudEntity extends Entity {
    ...
    private static final ParticleEffect PARTICLE = ParticleTypeRegistry.MILK_AREA_EFFECT;
    ...
    public MIlkAreaEffectCloudEntity(World world, double x, double y, double z) {
        this(EntityRegistry.MILK_AREA_EFFECT_CLOUD, world);
        setPosition(x, y, z);
    }
    ...
    public LivingEntity getOwner() {
        if (owner == null && ownerUUID != null && world instanceof ServerWorld) {
            Entity entity = ((ServerWorld) world).getEntity(ownerUUID);
